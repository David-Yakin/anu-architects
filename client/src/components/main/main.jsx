        ...
        <div className="container position-relative px-0">
          <div className="nav-main">
            <nav className="d-none d-xl-flex flex-row-reverse justify-content-between mx-0">
              ...
              <Link className="nav-a" to="about" smooth={true} duration={1000}>
                אודות
              </Link>
              <Link
                className="nav-a"
              ...
              <Link className="nav-a" to="blog" smooth={true} duration={1000}>
                בלוג
              </Link>
              <Link className="nav-a" to="faq" smooth={true} duration={1000}>
                שאלות ותשובות
              </Link>
              <Link
                className="nav-a"
