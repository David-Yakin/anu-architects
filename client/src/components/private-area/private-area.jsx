        ...
        return ( 
            ...
            <div className="col-11 col-xl-10 p-0">
                <Switch>
                    ...
                    <ProtectedRoute path='/private-area/create-project-card' component={CreateProject} title={"isAdmin"}/>
                    <ProtectedRoute path='/private-area/user/:id' component={UserInfo} title={"isAdmin"}/>
                    <ProtectedRoute path='/private-area/edit-project-card/:id' component={EditProject} title={"isAdmin"}/>
                    ...
                    <ProtectedRoute path='/private-area/create-resume-card' component={CreatResume} title={"isAdmin"}/>
                    <ProtectedRoute path='/private-area/edit-resume-card/:id' component={EditResume} title={"isAdmin"}/>
                    
                    <ProtectedRoute path='/private-area/create-qna-card' component={createQna} title={"isAdmin"}/>
                    <ProtectedRoute path='/private-area/edit-qna-card/:id' component={EditQna} title={"isAdmin"}/>
